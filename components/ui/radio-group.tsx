...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "border-input text-primary focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 aria-invalid:ring-destructive/20 aria-invalid:border-destructive bg-white aspect-square size-5 shrink-0 rounded-full border-2 shadow-sm transition-all outline-none hover:border-gray-400 disabled:cursor-not-allowed disabled:opacity-50",
