...
export function SCJudgements() {
  const yearRanges = [
    { id: "2020-2025", label: "2020 - 2025", years: ["2025", "2024", "2023", "2022", "2021", "2020"] },
    { id: "2010-2019", label: "2010 - 2019", years: ["2019", "2018", "2017", "2016", "2015", "2014", "2013", "2012", "2011", "2010"] },
    { id: "2000-2009", label: "2000 - 2009", years: ["2009", "2008", "2007", "2006", "2005", "2004", "2003", "2002", "2001", "2000"] },
    { id: "1990-1999", label: "1990 - 1999", years: ["1999", "1998", "1997", "1996", "1995", "1994", "1993", "1992", "1991", "1990"] },
    { id: "1980-1989", label: "1980 - 1989", years: ["1989", "1988", "1987", "1986", "1985", "1984", "1983", "1982", "1981", "1980"] },
    { id: "1970-1979", label: "1970 - 1979", years: ["1979", "1978", "1977", "1976", "1975", "1974", "1973", "1972", "1971", "1970"] },
    { id: "1960-1969", label: "1960 - 1969", years: ["1969", "1968", "1967", "1966", "1965", "1964", "1963", "1962", "1961", "1960"] },
    { id: "1950-1959", label: "1950 - 1959", years: ["1959", "1958", "1957", "1956", "1955", "1954", "1953", "1952", "1951", "1950"] }
  ]
  ...
  const latestJudgements = [
    {
      id: "19424",
      date: "12/09/25",
      title: "Prakash Asphallings and Toll Highways (India) Ltd. Vs. Mandeepa Enterprises",
    ...
    },
    {
      id: "19421",
      date: "12/09/25",
      title: "Confederation of Real Estate Developers Association of India (CREDAI) Vs. Union of India",
    ...
    },
    {
      id: "19416",
      date: "12/09/25",
      title: "Raju Mema Shinuatraa Rajeshwar Ramdas Sheth Vs. Khramshai Shakarsitaa Patel",
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-100 p-4 rounded border">
          <h2 className="text-xl font-semibold text-center mb-4">Supreme Court Judgements</h2>
        </div>
      </div>
          ...
          <div className="bg-white border border-gray-300 rounded">
            ...
            <div className="bg-blue-500 text-white p-3 rounded-t flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button className="bg-blue-600 text-white px-3 py-1 rounded text-xs">📊 Share</button>
                <button className="bg-black text-white px-3 py-1 rounded text-xs">✗ Post</button>
              </div>
            </div>
            ...
            <div className="p-4 border-b">
              <div className="flex gap-2">
                ...
                />
                <button className="bg-gray-600 text-white px-3 py-1 rounded text-sm">🔍</button>
              </div>
            </div>
              ...
              <div className="space-y-3">
                {latestJudgements.map((judgement, index) => (
                  <div key={judgement.id} className="flex gap-3 text-sm">
                    <span className="text-blue-600 font-medium">{judgement.date}</span>
                    <Link 
                      href={judgement.link}
